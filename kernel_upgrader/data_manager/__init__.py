...
class Compiler:
    ...
    def copy_latest_config(self):
        ...
        if any_found is not None:
            from kernel_upgrader.values import COPY_BOOT_CONFIG
    ...
    def adaptOldConfig(self):
        from kernel_upgrader.values import ADAPT_OLD_CONFIG
    ...
    def compileKernel(self):
        from kernel_upgrader.values import COMPILE_NEW_KERNEL, REPO_URL
    ...
    def installKernel(self):
        from kernel_upgrader.values import INSTALL_NEW_KERNEL
